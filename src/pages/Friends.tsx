      ...
      <div className="p-4 space-y-4">
        ...
        <div className="text-center py-8">
          ...
          <div className="flex gap-2 mb-4">
            <input
              className="flex-1 bg-card border border-line rounded-xl px-4 py-3 text-sm"
              value={referralLink}
              readOnly
            />
            <button
          ...
          <p className="text-xs text-textMute">
            ...
            TON, <span className="text-primary">смотреть условия</span>
          </p>
        </div>
        ...
        <div className="card p-4">
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-sm text-textMute mb-2">
